...
public class KdTreeTest {
    ...
    public void givenEmptyListKdTreeRootIsNull() {
        DimensionalKdTree<Star> kdtree = new DimensionalKdTree<>(Collections.emptyList());
        Assertions.assertEquals(null, kdtree.getRoot());
    }

    @Test
    public void givenListOfDataItBuildsTree() {
        KdTree<Star> kdTree = new DimensionalKdTree<>(bigTree());
    ...
    public void itReturnsLocationIfNearestNeighborInTree() {
        ...
        Star nearestNeighbhor = kdTree.nearestNeighbor(new Star(new int[]{5,5,5}));
    ...
    public void itFindsNearestNeighbhorOnSmallTree() {
        ...
        Assertions.assertArrayEquals(new int[]{2,2,2}, nearestNeighbhor.getCoordinates());
    }
    ...
    public void itFindsTheNearestNeighbhorOnBigTree() {
        ...
        Star nearestNeighbhor =  kdTree.nearestNeighbor(new Star(new int[]{10,10,10}));

        //Assert: Expect answer to be {9, 9, 9}
        Assertions.assertArrayEquals(new int[]{9,9,9}, nearestNeighbhor.getCoordinates());
    ...
    public void itReturnsNullIfLocationIsNull() {
        KdTree<Star> kdTree = new DimensionalKdTree<>();
    ...
    public void itFindsNearestNeighborGivenNegativeLocation() {
        ...
        Star nearestNeighbhor =  kdTree.nearestNeighbor(new Star(new int[]{-100,-100,-100}));

        //Assert: Expect answer to be {0, 0, 0}
        Assertions.assertArrayEquals(new int[]{0,0,0}, nearestNeighbhor.getCoordinates());
    ...
    public void kNearestNeighborsFindsSameValueAsNN() {
        ...
        Star nearestNeighbhor =  kdTree.nearestNeighbor(new Star(new int[]{-100,-100,-100}));
        List<Star> kNN = kdTree.kNearestNeighbors(new Star(new int[]{-100,-100,-100}), 1);
    ...
    public void kNearestNeighborsFindsNearestNeighbors() {
        ...
        //Act: Call nearest neighbhor to point {-100,-100,-100}
        List<Star> kNN = kdTree.kNearestNeighbors(new Star(new int[]{-100,-100,-100}), 3);
    ...
    public void radiusSearchFindsAllDataInRange() {
        ...
        //Act: Call nearest neighbhor to point {-100,-100,-100}
        Set<Star> inRange = kdTree.radiusSearch(new Star(new int[]{0, 0,0}), 5);
    ...
    private List<Star> bigTree() {
        ...
        Star a = new Star("Sirius", 1, new int[]{0,0,0});
        Star b = new Star("Arcturus", 2, new int[]{1,1,1});
        Star c = new Star("Rigel", 3, new int[]{2,2,2});
        Star d = new Star("Aldebaran",4, new int[]{3,3,3});
        Star e = new Star("Fomalhaut", 5, new int[]{4,4,4});
        Star f = new Star("Vega", 5, new int[]{5,5,5});
        Star g = new Star("Deneb", 6, new int[]{6,6,7});
        Star h = new Star("Canopus", 7, new int[]{7,7,7});
        Star i = new Star("Altair" ,8, new int[]{8,8,8});
        Star j = new Star("Algol", 9, new int[]{9,9,9});
        data.add(a);
        data.add(b);
        data.add(c);
        data.add(d);
